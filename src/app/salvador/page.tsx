    ...
    <main className="min-h-screen bg-background text-foreground scroll-smooth pt-20">
      ...
      <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm font-medium text-slate-600 dark:text-slate-300">
          <span className="flex items-center gap-1"><Star className="w-4 h-4 text-emerald-500 fill-emerald-500" />4.8 (10k+ avaliações)</span>
          <span className="flex items-center gap-1"><MapPin className="w-4 h-4" />Bahia, Brasil</span>
          <span className="flex items-center gap-1 text-emerald-600 dark:text-emerald-400"><CheckCircle2 className="w-4 h-4" />Destino Cultural</span>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
         <div className="w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-xl bg-slate-200 dark:bg-slate-800 flex items-center justify-center">
            <span className="text-slate-400 font-bold">Imagens do Pelourinho... (Em breve)</span>
         </div>
      </section>
        ...
        <div className="md:col-span-2 space-y-8">
           <div>
             ...
             <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg mb-6">
               Primeira capital do Brasil, Salvador é o coração da cultura afro-brasileira. Famosa por sua arquitetura colonial portuguesa, culinária rica, praias e uma energia festiva contagiante.
             </p>
             <div className="flex gap-4 flex-wrap">
               <div className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg text-sm font-semibold">
                 <Calendar className="w-4 h-4 text-emerald-500" />Dezembro a Março
               </div>
             </div>
           </div>
        </div>
