    ...
    <main className="min-h-screen bg-white pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-700 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">1. Aceitação dos Termos</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">2. Descrição do Serviço</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">3. Uso Aceitável</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">4. Propriedade Intelectual</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">5. Limitação de Responsabilidade</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">6. Contato</h2>
