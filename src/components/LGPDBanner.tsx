    ...
    <div className="fixed bottom-0 left-0 right-0 z-[60] p-4 md:p-6">
      <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200 p-6 flex flex-col md:flex-row items-start md:items-center gap-4">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div>
            <h4 className="font-bold text-slate-900 dark:text-white text-sm mb-1">Política de Privacidade (LGPD)</h4>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            onClick={reject}
            className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-full text-sm font-medium hover:bg-slate-200 transition-colors"
          >
            Recusar
          </button>
          <button onClick={reject} className="p-1 text-slate-400 hover:text-slate-600 dark:text-slate-300" aria-label="Fechar">
            <X className="w-4 h-4" />
          </button>
        </div>
      </div>
