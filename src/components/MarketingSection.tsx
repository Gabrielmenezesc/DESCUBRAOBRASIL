        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {marketingServices.map((svc, i) => (
            <motion.div
              ...
              className="glass-card group p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 hover:border-emerald-200 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300 flex flex-col h-full"
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4 tracking-tight group-hover:text-emerald-600 transition-colors">{svc.title}</h3>
